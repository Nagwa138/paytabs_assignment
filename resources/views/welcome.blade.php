    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex justify-center" style="margin-top: 2vh">
                ...
                <div class="flex justify-center text-center"
                     style="flex-direction: column;align-content: center;color: white;margin: auto">
                    <p>
                        Categories List
                    </p>
        ...
        $(document).ready(function(){
            ...
            function appendContent(categoryId) {
                ...
                $.ajax({
                    ...
                    url:url,
                    success:function(data){
                        if ( (!$('#cat-' + categoryId).length) && data.data.length > 0)
                        {
                            let newCategory = ''
                            ...
                            newCategory+='</select></div>'
                                let newAppend = $('.categories-container').append(newCategory)
                                newCategory = ''
                                $(".categories", newAppend).change(function(e){
                                    e.preventDefault();
                                    appendContent($(this).val())
                                });
                                newAppend = ''
                            ...
                            Swal.fire(
                                'Ops!',
                                'Category May not have children',
                                'warning'
                            )
                        }
                    },
                    error:function (error) {
                        Swal.fire(
                            'Failed!',
                            'Error Occurred, Category May not have children',
                            'error'
                        )
                    }
                });
